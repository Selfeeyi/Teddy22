...
import NavTabs from "../../components/Tabs/NavBarItem";
...
import Flowers from "../../components/Tabs/Flowers";
import Lights from "../../components/Tabs/Lights";
import Marque from "../../components/Tabs/Marque";
...
let LightMarque = () => {
  ...
  useEffect(() => {
    ...
    const isDesiredRoute = location.pathname === '/geztemart';
  ...
  return (
    ...
    <div className={""}>
      ...
      >
        <div style={{  borderBottom:currentPath === '/caters' ? '4px solid black' : '', paddingBottom:currentPath === '/caters'?10:""}}>
          <button
            onClick={() => navigate("/caters")}
            style={{
              backgroundColor: currentPath === '/caters' ? "var(--background-color)" : '#696969', // Set different colors based on the current path
              color: 'white',
              outline: 'none',
              border: 'none',
              width: '100%',
        ...
        <div style={{  borderBottom:currentPath === '/resturants' ? '4px solid black' : '', paddingBottom:currentPath === '/resturants'?10:""}}>
          <button
            ...
            style={{
              backgroundColor: currentPath === '/resturants' ? "var(--background-color)" : '#696969', // Set different colors based on the current path
              color: 'white',
              outline: 'none',
              border: 'none',
              width: '100%',
        ...
        <div style={{  borderBottom:currentPath === '/corporate' ? '4px solid black' : '', paddingBottom:currentPath === '/corporate'?10:""}}>
          <button
            onClick={() => navigate("/corporate")}
            style={{
              backgroundColor: currentPath === '/corporate' ? "var(--background-color)" : '#696969', // Set different colors based on the current path
              color: 'white',
              outline: 'none',
              border: 'none',
              width: '100%',
        ...
        <div style={{  borderBottom:currentPath === '/geztemart' ? '4px solid black' : '', paddingBottom:currentPath === '/geztemart'?10:""}}>
          <button
            ...
            style={{
              backgroundColor: currentPath === '/geztemart' ? "var(--background-color)" : '#696969', // Set different colors based on the current path
      ...
      <div className={""}>
        ...
        <div className={"css.w7"}>
          <div
            ...
            style={{ fontFamily: "DexaSemi", color: "var(--primary-color)",paddingInline:"10%" }}
          >
          Nightlife Restaurants in Bangalore
          </div>
          <div className={"css.innerDiv6Body"} style={{display:"flex",flexDirection:"row",gap:20}}>
            <div className={"css.innerDiv3"} style={{paddingTop:50}} >
              <div className={"css.filtersDiv"} style={{display:"flex",flexDirection:'column',gap:20}} >{filterBoxes}</div>
            </div>

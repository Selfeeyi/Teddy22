...
<div
  ...
  {/* Brand Slider */}
      ...
      <Modal style={{  borderRadius: '10rem', }} isOpen={createModalone} onClose={() => setCreateModalone(false)}>
        <div
           style={{
            backgroundColor: "white",
            width: 500,
     ...
     <div style={{marginBottom:'0rem'}}>
      <p style={{ marginLeft: '5rem' }}>Max Guest:</p>
      <form action="">
      <input
        type="number"
        // min="1"
      ...
      <DemoContainer components={["StaticDateTimePicker", "MobileDateTimePicker"]}>
        <DemoItem onChange={onClickHandle} style={{ marginLeft: '2rem',border:'2px solid blue' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <label style={{ marginBottom: '0.5rem', fontWeight: "600", color: "#041a68" }}>Date Of Food Delivery & Time:</label>
...
/>
          ...
          <div style={{ width: "100%", marginBlock: "7%" }}>
            <p
              style={{
                margin: 0,
                fontWeight: "600",

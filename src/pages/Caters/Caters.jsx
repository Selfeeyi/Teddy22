...
//           "https://gezte.com/api/businesswise_service_provider_details.php?business_topics='catering'"
//         );
...
//                     <ResturantCard {...restaurant.restaurant_details} />
...
//           >
//             <div style={{}}>
//               <p style={{ margin: 0 }}>No. of Members </p>
//               <input
//               type="number"
//               name="amountOfMembers"
//               value={formData.amountOfMembers}
//                 // type="number"
//                 // name='amountOfMembers'
//                 // value={members}
//                 // onChange={() => setMembers()}
...
//             </div>
//             <div>
//               <RxCross2 size={25} onClick={() => setCreateModalone(false)} />
//             </div>
//           </div>
//           <div>
//             <div style={{ height: "50%" }}>
...
//                 <DemoContainer
//                   components={["StaticDateTimePicker", "MobileDateTimePicker"]}
//                 >
//                   <DemoItem label="Pick Date and Time" onChange={onClickHandle}>
...
//   <div style={{ height: "50%", width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center',marginTop:'0.4rem' }}>
//     <LocalizationProvider dateAdapter={AdapterDayjs}>
...
//           <div style={{ width: "100%", marginBlock: "7%" ,marginTop:'1.8rem'}}>
//             <p
//               style={{
//                 margin: 0,
//                 fontWeight: "600",
...
/>
      ...
      <Modal1 isOpen={isFilterModalOpen} onClose={() => setIsFilterModalOpen(false)}>
        ...
        <h2 style={{fontSize:'24px',fontWeight:'800'}} >Filter</h2>
        <hr />
<div style={{marginLeft:'-2rem' , rowGap:'20px'}}><ul>
  <li style={{marginBottom:'20px', fontSize:'18px',fontWeight:'700'}}>Sort</li>
<li style={{marginBottom:'20px' ,fontSize:'18px',fontWeight:'700'}}>Delivery Time</li>
<li style={{marginBottom:'20px',fontSize:'18px',fontWeight:'700'}}> Fast Delivery</li>
<li style={{marginBottom:'20px',fontSize:'18px',fontWeight:'700'}}> Veg</li>
<li style={{marginBottom:'20px',fontSize:'18px',fontWeight:'700'}}>Rs 100-Rs 250</li>
<li style={{marginBottom:'20px',fontSize:'18px',fontWeight:'700'}}>Rs 250+</li>
<li style={{marginBottom:'20px',fontSize:'18px',fontWeight:'700'}}>Rs 250+</li>
<li style={{marginBottom:'20px',fontSize:'18px',fontWeight:'700'}}>NonVeg</li>

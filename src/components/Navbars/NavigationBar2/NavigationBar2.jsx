...
let NavigationBar = ({ toogleMenu, setToggleMenu }) => {
  ...
  return (
    ...
    <div style={{ paddingBlock: "1%"}}>
      ...
      >
        <div style={{width:330,height:188,backgroundSize: 'cover',backgroundPosition: 'center',position:'absolute',top:-54,display:'flex',justifyContent:'center',alignItems:'center',marginLeft:30}}>
          <h3 style={{textAlign:'center',fontSize:50,fontFamily:'Metropolis Black 1000', fontWeight:'bold',backgroundImage:' linear-gradient(to right, #d01ba8, #ff3f61)',WebkitBackgroundClip:'text',backgroundClip:'text',color:'transparent'}}>
            <span style={{}} color=" #d01ba8">Ted</span>
            <span  color="#ff3f61">eey</span>
          </h3> 
        </div>
